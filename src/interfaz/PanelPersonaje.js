...
export class PanelPersonaje {
  constructor({ contenedor, plantilla, configuracionHabilidades = null } = {}) {
    ...
    this.contenedor=contenedor; this.plantilla=plantilla; this.configuracionHabilidades=configuracionHabilidades; this.playerActual=null; this.juegoActual=null;
    this.indiceEfectos=crearIndiceEfectos(configuracionHabilidades); this.modalDetalle=new ModalDetalleEstadistica();
