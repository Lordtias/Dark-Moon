...
//
// Utilizamos constantes para evitar escribir nombres
// diferentes para una misma familia de acciones.
...
export class SistemaTiempo {
  constructor() {
    ...
    // Relaciona cada actor con
    // su información temporal.
    this.registros = new Map();

    // Contador utilizado para resolver
    // empates sin introducir azar.
  ...
  // Indica si un actor ya pertenece
  // a la agenda.
  tieneActor(actor) {
  ...
  // Avanza el reloj hasta
  // un instante concreto.
  //
  // También se utiliza para procesar
  // eventos periódicos, como regeneración.
  ...
  registrarAccion({ actor, tipoAccion, costoBase } = {}) {
    ...
    // Normalmente el tiempo actual y
    // el próximo turno del actor coinciden.
  ...
  // Devuelve el orden exacto
  // de la agenda actual.
  //
  // Puede utilizarse para diagnóstico
  // o para una interfaz futura.
  obtenerOrdenActual() {
